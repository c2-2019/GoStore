...
var mainView = myApp.addView('.view-main', {
  ...
  var mySwiper = myApp.swiper('.best-sellers', {
    //autoplay: 2500,
    autoplayDisableOnInteraction: false,
...
myApp.onPageInit('shop', function (page) {
  ...
  size_li = $(".shop-list").size();
    b = 4;
    $('.shop-list:lt('+b+')').show();  
    $('.click-shop').click(function () {
        b= (b+4 <= size_li) ? b+4 : size_li;
        $('.shop-list:lt('+b+')').show(1000);  
        if(size_li<=b)
            {
             $(".click-shop").hide(1000);
            }     
    });
